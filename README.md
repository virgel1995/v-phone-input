...
[![npm version](https://img.shields.io/npm/v/v-react-phone.svg?style=flat)](https://www.npmjs.com/package/v-react-phone)
[![npm downloads](https://img.shields.io/npm/dm/v-react-phone.svg?style=flat)](https://www.npmjs.com/package/v-react-phone)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/virgel1995/v-react-phone#contributing)
[![travis build](https://travis-ci.org/virgel1995/v-react-phone.svg?branch=master)](https://travis-ci.org/virgel1995/v-react-phone)

![animation](https://media.giphy.com/media/xiORAWnqoTJDsH0UOI/giphy.gif)

## Installation
```shell-script
npm install v-react-phone --save
```

## Usage
```jsx
import PhoneInput from 'v-react-phone'
import 'v-react-phone/lib/style.css'
...
#### [Demo 1 (UI)](https://virgel1995.github.io/v-react-phone.html) - [Demo 2 (CSS)](https://virgel1995.github.io/v-react-phone-css.html)

![screenshot](https://raw.githubusercontent.com/virgel1995/v-react-phone/master/test/screenshot.png)
...
```jsx
import es from 'v-react-phone/lang/es.json'
...
### CDN
```html
<script src="https://unpkg.com/v-react-phone@0.x/dist/lib.js"></script>
```
...
## License
[![GitHub license](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/virgel1995/v-react-phone/blob/master/LICENSE)

Based on [v-react-phone-input](https://github.com/razagill/v-react-phone-input)
